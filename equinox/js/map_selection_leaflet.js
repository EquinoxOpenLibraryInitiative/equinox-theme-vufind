...
function loadMapSelection(geoField, boundingBox, baseURL, homeURL, searchParams, resultsCoords, basemap) {
  ...
  var redIcon = new searchIcon({
    iconUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/marker-icon-2x-red.png',
    shadowUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/marker-shadow.png'
  });
  
  var redRectIcon = new searchIcon({
    iconUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/rectangle-icon-2x-red.png',
    shadowUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/marker-shadow.png'
  });

  // Blue will be used when a user selects a geofeature
  var blueIcon = new searchIcon({
    iconUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/marker-icon-2x-blue.png',
    shadowUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/marker-shadow.png'
  });
  var blueRectIcon = new searchIcon({
    iconUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/rectangle-icon-2x-blue.png',
    shadowUrl: VuFind.path + '/themes/equinox/css/vendor/leaflet/images/marker-shadow.png'
  });
